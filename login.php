...
<div class="container">
  ...
  <div class="row">
    <div class="column">
      <img src="images/home2.jpg" style="width:600px;height:600px; border-radius:50% ">
    </div>
    <div class="column">
     <form name="myForm" action="login_check.php" onsubmit="return validateForm()" method="post">
        ...
        <button type="submit" value="login" onclick="return validateForm()">Login</button>
      </form>
    </div>
...
function validateForm() {
  ...
  if (f == "" || e=="" || p=="" ) {
    ...
    return false;}
    else{alert("Welcome Back Loyal Customer");}
